...
async function main() {
  try {
    const ethereumBridgeAddress = '0x39F0239b5B0E00a6090B861FBbd9556805172e25'; // Ethereum FlyingCars contract address
    const accountAddress = '0x7216a540A40B4f77D93DAE63CEc29752f83092b9'; // Your account address
    const FxERC721RootTunnelArtifact = require("../bridgeContract/rootContractABI.json");

    // Connect to the Ethereum and Polygon networks
    const ethereumBridge = await ethers.getContractAt("FlyingCars",ethereumBridgeAddress);

    const fxERC721RootTunnel = await ethers.getContractAt(FxERC721RootTunnelArtifact,"0xF9bc4a80464E48369303196645e876c8C7D972de");
